...
public class HttpClientUtil {
	 ...
	 * @throws IOException
	 */
	public static String loginInBeforeSend(String url, Map<String,String> map) throws ParseException, IOException{
		String body = "";
		...
		String sign = Encryption.encryption(appKey+account+timeStamp+pwd+IMEI);
	 ...
	 * @throws IOException
	 */
	public static String send(String url, Map<String,String> map) throws ParseException, IOException{
		String body = "";
		url = "http://localhost:8080/eteacher/remote/"+url;
		String encoding = "utf-8";
		//创建httpclient对象
		...
		String token = "f596446453fe0178986cbc1f2096c6dc";
		String pwd = "a152e841783914146e4bcd4f39100686";
